...
function getRegionEmoji(region) {
  const emojiMap = {
    ...
    '용산구': '🏢', '중구': '🏢', '중랑구': '🏢',
    // 경기 시
    '수원시': '🏘️', '성남시': '🏘️', '의정부시': '🏘️', '평택시': '🏘️',
    '동두천시': '🏘️', '안산시': '🏘️', '고양시': '🏘️', '과천시': '🏘️',
    '구리시': '🏘️', '남양주시': '🏘️', '오산시': '🏘️', '시흥시': '🏘️',
    '군포시': '🏘️', '의왕시': '🏘️', '하남시': '🏘️', '용인시': '🏘️',
    '파주시': '🏘️', '이천시': '🏘️', '안성시': '🏘️', '김포시': '🏘️',
    '화성시': '🏘️', '광주시': '🏘️', '여주시': '🏘️', '양주시': '🏘️',
    '포천시': '🏘️', '연천군': '🏘️',
    // 인천 구
    '중구': '⚓', '동구': '⚓', '남구': '⚓', '북구': '⚓',
    '강화군': '⚓', '옹진군': '⚓', '미추홀구': '⚓', '연수구': '⚓',
...
function getRegionGroup(region) {
  const groupMap = {
    ...
    '용산구': '서울', '중구': '서울', '중랑구': '서울',
    // 경기 시
    '수원시': '경기도', '성남시': '경기도', '의정부시': '경기도', '평택시': '경기도',
    '동두천시': '경기도', '안산시': '경기도', '고양시': '경기도', '과천시': '경기도',
    '구리시': '경기도', '남양주시': '경기도', '오산시': '경기도', '시흥시': '경기도',
    '군포시': '경기도', '의왕시': '경기도', '하남시': '경기도', '용인시': '경기도',
    '파주시': '경기도', '이천시': '경기도', '안성시': '경기도', '김포시': '경기도',
    '화성시': '경기도', '광주시': '경기도', '여주시': '경기도', '양주시': '경기도',
    '포천시': '경기도', '연천군': '경기도',
    // 인천 구
    '중구': '인천', '동구': '인천', '남구': '인천', '북구': '인천',
    '강화군': '인천', '옹진군': '인천', '미추홀구': '인천', '연수구': '인천',
    '남동구': '인천', '부평구': '인천', '계양구': '인천',
    // 나머지 도
    '강원도': '강원도', '강원': '강원도',
    '충청북도': '충청북도', '충북': '충청북도',
    '충청남도': '충청남도', '충남': '충청남도',
